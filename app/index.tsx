...
export default function Screen() {
    ...
    return (
        <View className='w-full items-center bg-secondary h-full'>
            <View className='flex-1 items-center p-3 pt-5 bg-secondary text-primary w-full max-w-xl'>
                ...
                <View className='w-full'>
                    ...
                    <Card className='w-full gap-3 p-4 rounded-2xl bg-secondary pb-14 mt-1'>
                        <View className='items-center'>
                            ...
                            <Text
                                className='font-semibold text-gray-500 dark:text-gray-300 text-sm'>{formatNumber(calories)} / {formatNumber(maxCalories)} kcal</Text>
                        </View>
                    ...
                    <Card className='w-full gap-3 p-4 rounded-2xl bg-secondary pb-6 mt-1'>
                        <View className='flex-row items-center'>
                            <CoffeeIcon className='mr-3 w-7 h-7'/>
                            <View className='items-center w-2/3'>
                                <Text className='mb-1 font-semibold w-full'>Breakfast</Text>
                                <Progress value={breakfast / maxBreakfast * 100}
                                          className='h-2 bg-gray-400 dark:bg-gray-600'/>
                                <Text
                        ...
                        <View className='flex-row items-center'>
                            <SandwichIcon className='mr-3 w-7 h-7'/>
                            <View className='items-center w-2/3'>
                        ...
                        <View className='flex-row items-center'>
                            <UtensilsIcon className='mr-3 w-7 h-7'/>
                            <View className='items-center w-2/3'>
                                <Text className='mb-1 font-semibold w-full'>Dinner</Text>
                                <Progress value={dinner / maxDinner * 100}
                                          className='h-2 bg-gray-400 dark:bg-gray-600'/>
                                <Text
                        ...
                        {displaySnacks && <View className='flex-row items-center'>
                            <CandyIcon className='mr-3 w-7 h-7'/>
                            <View className='items-center w-2/3'>
                                <Text className='mb-1 font-semibold w-full'>Snacks</Text>
                                <Progress value={snacks / maxSnacks * 100}
                                          className='h-2 bg-gray-400 dark:bg-gray-600'/>
                                <Text
